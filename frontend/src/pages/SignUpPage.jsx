...
function SignUpPage() {
  ...
  const handleSignIn = async (e) => {
    ...
    try {
      const data = await signUpEmailPassword(email, password)
      console.log(data)
      if(!data.isError){
        ...
        <div className="min-h-screen flex items-center justify-center bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
          <div className="max-w-md w-full bg-white rounded-lg shadow-lg overflow-hidden">
            <div className="px-6 py-8">
              <h2 className="text-center text-3xl font-extrabold text-gray-900">Welcome to tieron</h2>
              ...
              <div className="text-sm text-center p-5">
                ...
                <a href="/signip" className="font-medium text-indigo-600 hover:text-indigo-500">
                  Sign In
                </a>
              </div>
            </div>
